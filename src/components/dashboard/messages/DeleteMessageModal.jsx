...
export default function DeleteMessageModal({ message, onCancel, onConfirm, loading }) {
  return (
    <Modal open={!!message} onClose={onCancel} title="Delete Message?" size="sm">
      <div className="flex items-start gap-3">
        ...
        <div>
          <p className="text-sm text-[#1F2937] leading-relaxed">
            ...
            <span className="font-semibold text-[#0B1E3D]">"{message?.full_name}"</span> will be
            permanently deleted.
          </p>
        </div>
      </div>
