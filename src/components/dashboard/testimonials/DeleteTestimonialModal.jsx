...
export default function DeleteTestimonialModal({ testimonial, onCancel, onConfirm, loading }) {
  return (
    <Modal open={!!testimonial} onClose={onCancel} title="Delete Testimonial?" size="sm">
      <div className="flex items-start gap-3">
        ...
        <div>
          <p className="text-sm text-[#1F2937] leading-relaxed">
            ...
            <span className="font-semibold text-[#0B1E3D]">"{testimonial?.client_name}"</span> will be
            permanently deleted. The client photo will also be removed from storage.
          </p>
        </div>
      </div>
