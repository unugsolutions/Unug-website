...
export default function DeleteServiceModal({ service, onCancel, onConfirm, loading }) {
  return (
    <Modal open={!!service} onClose={onCancel} title="Delete Service?" size="sm">
      <div className="flex items-start gap-3">
        ...
        <div>
          <p className="text-sm text-[#1F2937] leading-relaxed">
            ...
            <span className="font-semibold text-[#0B1E3D]">"{service?.title}"</span> will be permanently
            deleted.
          </p>
        </div>
      </div>
