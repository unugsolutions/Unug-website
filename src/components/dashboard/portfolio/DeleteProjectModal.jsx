...
export default function DeleteProjectModal({ project, onCancel, onConfirm, loading }) {
  return (
    <Modal open={!!project} onClose={onCancel} title="Delete Project?" size="sm">
      <div className="flex items-start gap-3">
        ...
        <div>
          <p className="text-sm text-[#1F2937] leading-relaxed">
            ...
            <span className="font-semibold text-[#0B1E3D]">"{project?.title}"</span> and its details
            will be permanently deleted. Uploaded images will also be removed from storage.
          </p>
        </div>
      </div>
