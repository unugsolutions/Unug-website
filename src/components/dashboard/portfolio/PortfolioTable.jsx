...
import { FolderKanban, ArrowUpDown, SortAsc, SortDesc, SearchX, AlertTriangle, Plus } from "lucide-react"
...
export default function PortfolioTable({ projects, loading, error, onRetry, onView, onEdit, onDelete, onAdd }) {
  ...
  return (
    ...
    >
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-5 2xl:gap-6 2xl:mb-6">
        <SearchBar placeholder="Search projects..." value={query} onChange={setQuery} className="w-full sm:max-w-xs 2xl:max-w-sm" />
      ...
      {loading ? (
        ...
        <EmptyState
          icon={query ? SearchX : FolderKanban}
          title={query ? "No results found" : "No projects yet"}
          description={
            query
              ? "Try a different search term."
              : "Add your first project to showcase your work."
          }
          action={query ? undefined : { label: "Add Project", icon: Plus, onClick: onAdd }}
        />
      ) : (
        <>
