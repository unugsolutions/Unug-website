...
// Confirmation dialog shown before permanently deleting a demo request.
export default function DeleteQuoteModal({ quote, onCancel, onConfirm, loading }) {
  return (
    <Modal open={!!quote} onClose={onCancel} title="Delete Demo Request?" size="sm">
      <div className="flex items-start gap-3">
        ...
        <div>
          <p className="text-sm text-[#1F2937] leading-relaxed">
            ...
            <span className="font-semibold text-[#0B1E3D]">"{quote?.reference_number}"</span> from{" "}
            <span className="font-semibold text-[#0B1E3D]">"{quote?.full_name}"</span> will be
            permanently deleted. Uploaded attachments will also be removed.
          </p>
        </div>
      </div>
