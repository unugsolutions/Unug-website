...
export default function DeleteTrustedCompanyModal({ company, onCancel, onConfirm, loading }) {
  return (
    <Modal open={!!company} onClose={onCancel} title="Delete Company?" size="sm">
      <div className="flex items-start gap-3">
        ...
        <div>
          <p className="text-sm text-[#1F2937] leading-relaxed">
            This action cannot be undone. The company{" "}
            <span className="font-semibold text-[#0B1E3D]">"{company?.name}"</span> will be permanently
            removed. Its uploaded logo will also be deleted from storage.
          </p>
        </div>
      </div>
